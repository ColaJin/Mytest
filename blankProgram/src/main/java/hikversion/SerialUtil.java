 ...
 * 组件: 串行通信组件
 * 版本: 1.0
 * 日期: 2016-3-21 下午05:52:06
 * 作者  陈海锋
 * Email: chenhaifeng@unitedmne.com
...
public class SerialUtil {
	...
	private static char[] crc_1021 = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7, 0x8108, 0x9129,
	...
	private static int[] crc_table = { 0x00000000, 0x77073096, 0xee0e612c, 0x990951ba, 0x076dc419, 0x706af48f,
	...
	public static byte[] caluCRC(byte[] pByte) {
		...
		reCrc[0] = (byte) ((crc & 0xFF00) >> 8);
		reCrc[1] = (byte) (crc & 0xFF);
		return reCrc;
	}
